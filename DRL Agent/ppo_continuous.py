...
# parser.add_argument(
#     '--gamma', type=double, default=0.9, metavar='G', help='discount factor (default: 0.9)')
...
class Agent():
    ...
    max_grad_norm = 0.5
    ppo_epoch = 10
    buffer_capacity, batch_size = 160, 32

    def __init__(self):
        self.training_step = 0
        self.anet = ActorNet().double()
        self.cnet = CriticNet().double()
        self.buffer = []
        self.counter = 0
